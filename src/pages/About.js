        ...
        <div className="card-body">
          ...
          <div className="card-content mx-4">
            ...
            <p className="about-card-text">
              Hello! My name is Shawn, and I'm a aspiring developer with a
              passion for building software that solves real-world problems. I'm
              constantly looking for new ways to improve my skills so that I am
            ...
            <p className="about-card-text">
              ...
              things. I believe in the importance of staying up-to-date with the
            ...
            <p className="about-card-text">
              ...
              would like to checkout any of my previous projects or my current
              projects, "check out my GitHub", etc.)]. I look forward to hearing
              from you!
            </p>
            <p className="about-card-text">
              Outside of coding, I enjoy music, sports, and all things movies,
